...
/**
 * Controller class for defining all controllers
...
public class EmployeeController {
    ...
    /**
     * Get method to retrieve single employee
     * @param employeeCode
    ...
    /**
     * Post end point to create or insert data into employee table
     * @param employee
     */
    @POST
    @Path("/employee")
...
//        employee.setDateOfBirth(date);
    ...
    /**
     * PUT endpoint to update data into Employee table
     * @param employee
     */
    @PUT
    @Path("/employee")
